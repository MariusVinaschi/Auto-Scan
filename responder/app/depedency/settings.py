...
try : 
    from app.depedency import utils
except: 
    from depedency import utils
...
class Settings: 
    ...
    def populate(self, options):
        ...
        # Db File
        folder_database = os.path.join(self.ResponderPATH,'database')
        self.DatabaseFile    = os.path.join(folder_database, config.get('Responder Core', 'Database'))
