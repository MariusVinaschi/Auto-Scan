...
try : 
	...
	from app.depedency.packets import MSSQLPreLoginAnswer, MSSQLNTLMChallengeAnswer
except :
	from depedency.utils import *
	from depedency.packets import MSSQLPreLoginAnswer, MSSQLNTLMChallengeAnswer
