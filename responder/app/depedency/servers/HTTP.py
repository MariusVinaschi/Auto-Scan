...
try:
	...
	from app.depedency.packets import IIS_Auth_401_Ans, IIS_Auth_Granted, IIS_NTLM_Challenge_Ans, IIS_Basic_401_Ans,WEBDAV_Options_Answer, NTLM_Challenge, WPADScript, ServeExeFile, ServeHtmlFile
except: 
	from depedency.utils import *
	from depedency.packets import IIS_Auth_401_Ans, IIS_Auth_Granted, IIS_NTLM_Challenge_Ans, IIS_Basic_401_Ans,WEBDAV_Options_Answer, NTLM_Challenge, WPADScript, ServeExeFile, ServeHtmlFile
