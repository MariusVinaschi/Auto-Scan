...
import sys 
try: 
	from app.depedency import fingerprint
	from app.depedency.packets import LLMNR_Ans
	from app.depedency.utils import *
except :
	from depedency import fingerprint
	from depedency.packets import LLMNR_Ans
